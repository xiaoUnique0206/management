...
- (UIView*)calanderAction{
    ...
    NSString *left = @"dia_right";
    NSString *right = @"dia_left";
...
//    [todayBtn setImage:[UIImage imageWithContentsOfFile:today] forState:UIControlStateNormal];
    ...
    self.collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0,CGRectGetMaxY(headView.frame), self.wWidth, self.layout.itemSize.height*6) collectionViewLayout:self.layout];
...
//        cell.dateLable.textColor = DialogColor(0xD9D9D9);
        cell.dateLable.textColor = [UIColor clearColor];
        ...
        if (model.wSelected) {
            ...
            cell.dateLable.backgroundColor = RGB(52, 137, 255);
...
- (void)UI{
    ...
    self.dateLable.frame = CGRectMake(0, 0, frame.size.width, frame.size.height);
    self.dateLable.layer.masksToBounds = YES;
    self.dateLable.layer.cornerRadius = frame.size.height/2;
