...
@interface DFYSliderSwitchView ()

@property (nonatomic, strong, readonly) DFYTopSwithView *tabBar;
@property (nonatomic, strong) UIScrollView *rootScrollView;

@end


@implementation DFYSliderSwitchView
...
- (void)initValues{
    ...
    // tab
    _tabBar = [[DFYTopSwithView alloc] init];
...
- (void)setViewControllers:(NSArray *)viewControllers {
    ...
    for (UIViewController *controller in _viewControllers) {
        ...
        DFYSwithItem *item = [DFYSwithItem buttonWithType:UIButtonTypeCustom];
    ...
    _tabBar.backgroundColor = MaingreenColor;
    _tabBar.frame = CGRectMake(0, 0, kSWidth, 50);
...
- (void)addOtherItem:(DFYSwithItem *)item{
    ...
    [_tabBar setOtherItem:item tapHandler:^(DFYSwithItem *item) {
