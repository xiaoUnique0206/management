...
#import "HMLevelTwoViewController.h"
#import "HMLevelThrViewController.h"
@interface HMLevelTwoViewController ()<dayLiveDelegata,UITableViewDelegate,UITableViewDataSource,sortingDayDelegate>
...
@implementation HMLevelTwoViewController
...
- (void)dayliveModel:(HMDayLiveModel *)model{
    if (model.children.count == 0) {
        ...
        HMLevelThrViewController *levelTwoVC = [HMLevelThrViewController new];
...
- (UITableView *)dayTableView{
    if (!_dayTableView) {
        ...
        [_dayTableView registerNib:[UINib nibWithNibName:@"HMDayLiveTableViewCell" bundle:nil] forCellReuseIdentifier:@"HMLeveTwoID"];
    }
