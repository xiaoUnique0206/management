...
@interface HMLevelThrViewController ()<dayLiveDelegata,UITableViewDelegate,UITableViewDataSource,sortingDayDelegate>
...
@implementation HMLevelThrViewController
